...
Consider a basic linear regression. There are a few ingredients we need to get started.

We create some dummy data, calculate a loss, and backpropagate to calculate gradients for the parameters `W` and `b`.
